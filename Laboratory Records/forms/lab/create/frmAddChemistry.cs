...
{
    public partial class frmAddChemistry : MetroFramework.Forms.MetroForm
    {
        ...
        public frmAddChemistry()
        {
            InitializeComponent();
        }

        private void frmAddChemistry_Load(object sender, EventArgs e)
        {
        ...
        {
            if (chemistry.AddChemistryRecord(val.RecordID, val.LabID, txtStat.Text, txtFastingBloodSugar.Text,
                txtRandomBloodSugar.Text, txtPostPrandial.Text, txtHBa1c.Text, txtUrea.Text, txtCreatinine.Text, txtUricAcid.Text,
                txtCholesterol.Text, txtTriglycerides.Text, txtHDL.Text, txtLDL.Text, txtSGOT.Text, txtSGPT.Text, txtSodium.Text,
                txtPotassium.Text, txtCalcium.Text, val.PatID, val.MedID))
            {
                MetroFramework.MetroMessageBox.Show(this, "Chemistry record saved!",
