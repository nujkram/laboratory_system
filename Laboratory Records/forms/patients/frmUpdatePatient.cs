...
{
    public partial class frmUpdatePatient : MetroFramework.Forms.MetroForm
    {
        ...
        {
            txtFirstName.Text = val.PatientFirstName;
            txtMiddleName.Text = val.PatientMiddleName;
            txtLastName.Text = val.PatientLastName;
            cboGender.Text = val.PatientGender;
            txtBirthDate.Text = val.PatientBirthDate.ToString("MM-dd-yyyy");
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (patient.UpdatePatient(val.PatientID, txtFirstName.Text, txtMiddleName.Text, txtLastName.Text, cboGender.Text, d2, int.Parse(txtAge.Text), txtAddress.Text))
            {
